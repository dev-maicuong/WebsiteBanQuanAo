...
{
    public class AdminQuanLyNguoiDungController : Controller
    {
        private DatabaseBanQuanAoEntities db = new DatabaseBanQuanAoEntities();

        // GET: AdminQuanLyNguoiDung
        public ActionResult Index()
        {
            return View(db.tbNguoiDungs.ToList());
        }

        // GET: AdminQuanLyNguoiDung/Details/5
        ...
        // GET: AdminQuanLyNguoiDung/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminQuanLyNguoiDung/Create
        ...
        // GET: AdminQuanLyNguoiDung/Edit/5
        ...
        // POST: AdminQuanLyNguoiDung/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminQuanLyNguoiDung/Delete/5
        ...
        // POST: AdminQuanLyNguoiDung/Delete/5
